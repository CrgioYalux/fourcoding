...
interface ClientToServerEvents {
	...
	'join-room': (
		data: Partial<Omit<ClientInitialRequest, 'roomID'>> &
			Pick<ClientInitialRequest, 'roomID'>
	) => void;
	'create-room': (
		data: Omit<Partial<ClientInitialRequest>, 'roomID'>
	) => void;
...
interface SocketData {
	clientHandshake: Omit<ClientInitialRequest, 'password'> &
		Pick<Partial<ClientInitialRequest>, 'password'>;
}
